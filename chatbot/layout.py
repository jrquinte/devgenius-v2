...
def login_page():
    ...
    # Main page content
    st.markdown("<h1 style='text-align: center;'>Welcome to DevGenius App v2</h1>", unsafe_allow_html=True)
...
def create_tabs():
    ...
    tabs = st.tabs(["Build a solution", "Modify your existing architecture", "🆕 Reverse Engineering"])
    return tabs
...
def create_reverse_option_tabs():
    """Create and return the Streamlit tabs for reverse engineering options."""
    tabs = st.tabs([
